...
//        val data1=  db.query("biotopeAttribute",dataList,null,null,"GROP_ID",null,"id asc",null);
        ...
        listView1.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
            ...
            addbiotope(biotope_attribute,domin.toString(),region.toString(),geom,tre_spec.toString(),stre_spec.toString(),shr_spec.toString(),her_spec.toString(),tre_fami.toString()
    ...
    fun addbiotope(biotope_attribute: Biotope_attribute,domin:String,region:String,geom:String,tre_spec:String,stre_spec:String,shr_spec:String
