...
//                val tmpfiles = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator + "ecology" + File.separator + "data/mammalia/images/")
                val tmpfiles = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator + "ecology/data" + File.separator + "mammal/images" + File.separator + keyId + File.separator)
                ...
                if (tmpfileList != null) {
                    for (i in 0..tmpfileList.size - 1) {
                        ...
                        for (j in 0..tmpfileList.size - 1) {
                            ...
                            if (images_path!!.get(i).equals(FileFilter.img(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/ecology/data" + File.separator + "mammal/images" + File.separator + keyId + File.separator, add_images[add_images.size - 1]))) {
                                //                            if (images_path!!.get(i).equals(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/ecology/data/mammal/images/" + mammal_attribute.NUM.toString() +"_"+mammal_attribute.INV_TM +"_" + (j+1) + ".png")) {
...
//                    }
                ...
                FROM_CAMERA -> {
                    ...
                    if (resultCode == -1) {
                        val outPath2 = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator + "ecology/data" + File.separator + "mammalia/images" + File.separator + keyId
                        addPicturesLL!!.removeAllViews()
...
//                        val num = mammalianumTV.text.toString()
                        var time = ""
                        time = mammaliainvtmTV.text.toString()
                        var timesplit = time.split(":")
                        invtm = timesplit.get(0) + timesplit.get(1)
...
//        val dayTime = SimpleDateFormat("yyyyMMddHHmmssSSS")
    ...
    override fun onBackPressed() {
        ...
        if (dataArray.size == 0 || intent.getStringExtra("id") == null){
            ...
            val path = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator + "ecology/data" + File.separator + "mammalia/images"+ File.separator +keyId+ File.separator)
//                                val path = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator + "ecology" + File.separator + "data/mammal/images/")
            val pathdir = path.listFiles()
