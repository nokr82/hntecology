...
class BridsClassAdapter2(var context: Context, var itemList : ArrayList<Region>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent : ViewGroup?): View {
        ...
        var Region : Region = getItem(position)

        viewHoldar.class_biotope_item.text = Region.MIDDLECATEGORY;

        if(Region.chkSelect == true){
