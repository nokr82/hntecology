...
class DlgBiotopeTypeAdapter1(var context: Context, var itemList : ArrayList<BiotopeType>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent : ViewGroup?): View {
        ...
        viewHoldar.class_biotope_item.text = BiotopeType.DIVISION;
