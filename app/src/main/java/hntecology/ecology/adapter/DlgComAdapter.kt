...
class DlgComAdapter(var context: Context, var itemList : ArrayList<common>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent : ViewGroup?): View {
        ...
        viewHoldar.biotope_item.text = common.title;
...
/*        for(i in 0.. (itemList.size-1)){
        ...
        var common:common = itemList.get(selectIndex);
        common.chkSelect = false
        itemList.set(selectIndex,common)
