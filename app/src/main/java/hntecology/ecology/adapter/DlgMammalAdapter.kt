...
class DlgMammalAdapter(var context: Context, var itemList : ArrayList<Mammal>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent : ViewGroup?): View {
        ...
        var Mammal : Mammal = getItem(position)

        viewHoldar.search_item.text = Mammal.name_kr;

        if(Mammal.chkSelect == true){
    ...
    override fun getItem(position: Int): Mammal {
