...
class DlgPointModiMamalAdapter(var context: Context, var itemList: ArrayList<Mammal_attribute>, var itemList2: ArrayList<Mammal_attribute>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        var Mammal_attribute: Mammal_attribute = getItem(position)
            viewHoldar.timeTV.text = Mammal_attribute.INV_DT+"\n"+Mammal_attribute.INV_TM;
            for (i in 0..itemList2.size - 1) {
                if (Mammal_attribute.GROP_ID == itemList2[i].GROP_ID) {
    ...
    override fun getItem(position: Int): Mammal_attribute {
    ...
    fun addItem(Biotope_attribute: Mammal_attribute) {
