...
class DlgProjectAdapter(var context: Context, var itemList : ArrayList<Projects>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): Projects {
    ...
    fun addItem(Projects: Projects){

        itemList.add(Projects);
        notifyDataSetChanged()
    }
