...
class DlgRobAdapter1(var context: Context, var itemList : ArrayList<common>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent : ViewGroup?): View {
        ...
        var common : common = getItem(position)

        viewHoldar.class_biotope_item.text =  common.code.toString() + " : " + common.title;

        if(common.chkSelect == true){
    ...
    override fun getItem(position: Int): common {
...
//        itemList.set(selectIndex,BiotopeClass)
        ...
        var common = getItem(position);

        common.chkSelect = true
        selectIndex= position
        itemList.set(position,common)
        notifyDataSetChanged()
    }
