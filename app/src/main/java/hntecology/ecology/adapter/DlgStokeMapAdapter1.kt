...
class DlgStokeMapAdapter1(var context: Context, var itemList : ArrayList<StockMapSelect>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): StockMapSelect {
    ...
    fun addItem(StockMapSelect: StockMapSelect){

        itemList.add(StockMapSelect);
        notifyDataSetChanged()
    }
