...
//        query += ", '" + insect_attribute.getINV_MN_ETC() + "'";
    ...
    public void insertfish_attribute(Fish_attribute fish_attribute){
        ...
        query += ",TEMPERATUR,ETC,MID_RAGE,CODE_NUM,RIVER_NUM,RIVER_NM,GPS_LAT";
...
//        query += ", '" + fish_attribute.getAD_DIST_NM() + "'";
    ...
    public void insertzoobenthos(Zoobenthos_Attribute Zoobenthos_Attribute){
        ...
        query += ", '" + Zoobenthos_Attribute.getGPSLAT_DEG() + "'";
        query += ", '" + Zoobenthos_Attribute.getGPSLAT_MIN() + "'";
        query += ", '" + Zoobenthos_Attribute.getGPSLAT_SEC() + "'";
        query += ", '" + Zoobenthos_Attribute.getGPSLON_DEG() + "'";
        query += ", '" + Zoobenthos_Attribute.getGPSLON_MIN() + "'";
        query += ", '" + Zoobenthos_Attribute.getGPSLON_SEC() + "'";
        ...
        query += ", '" + Zoobenthos_Attribute.getRIV_W() + "'";
        query += ", '" + Zoobenthos_Attribute.getRIV_W2() + "'";
        query += ", '" + Zoobenthos_Attribute.getRUN_RIV_W() + "'";
...
//        query += ", '" + Zoobenthos_Attribute.getDIST_ETC() + "'";
    ...
    public void delete_grop_reptilia_attribute(Reptilia_attribute reptilia_attribute,String GROP_ID) {
        String query = "DELETE FROM reptiliaAttribute WHERE GROP_ID = '" + GROP_ID + "'";

        SQLiteDatabase db = getWritableDatabase();
        db.execSQL(query);
        db.close();
    }
    public void delete_grop_zoo_attribute(Zoobenthos_Attribute reptilia_attribute,String GROP_ID) {
        String query = "DELETE FROM ZoobenthosAttribute WHERE GROP_ID = '" + GROP_ID + "'";
    ...
    public void delete_grop_flora_attribute(Flora_Attribute reptilia_attribute,String GROP_ID) {
        String query = "DELETE FROM floraAttribute WHERE GROP_ID = '" + GROP_ID + "'";
    ...
    public void delete_grop_insect_attribute(Insect_attribute insect_attribute,String GROP_ID) {
        String query = "DELETE FROM insect_attribute WHERE GROP_ID = '" + GROP_ID + "'";

        SQLiteDatabase db = getWritableDatabase();
        db.execSQL(query);
        db.close();
    }
    public void delete_grop_fish_attribute(Fish_attribute fish_attribute,String GROP_ID) {
        String query = "DELETE FROM fish_attribute WHERE GROP_ID = '" + GROP_ID + "'";
    ...
    public void deleteallbiotope_attribute(Biotope_attribute biotope_attribute,String page) {
        String query = "DELETE FROM biotopeAttribute WHERE IT_GROP_ID = '" + page + "'";
...
//                + ",AD_DIST_NM='" + fish_attribute.getAD_DIST_NM() + "'"
    ...
    public void updatezoobenthous_attribute(Zoobenthos_Attribute Zoobenthos_Attribute,String pk) {
        ...
        String query = "UPDATE ZoobenthosAttribute SET  " +
                ...
                + ",GPSLAT_MIN='" + Zoobenthos_Attribute.getGPSLAT_MIN() + "'"
                + ",GPSLAT_SEC='" + Zoobenthos_Attribute.getGPSLAT_SEC() + "'"
                + ",GPSLON_DEG='" + Zoobenthos_Attribute.getGPSLON_DEG() + "'"
                + ",GPSLON_MIN='" + Zoobenthos_Attribute.getGPSLON_MIN() + "'"
                + ",GPSLON_SEC='" + Zoobenthos_Attribute.getGPSLON_SEC() + "'"
                ...
                + ",RIV_W='" + Zoobenthos_Attribute.getRIV_W() + "'"
                + ",RIV_W2='" + Zoobenthos_Attribute.getRIV_W2() + "'"
                + ",RUN_RIV_W='" + Zoobenthos_Attribute.getRUN_RIV_W() + "'"
