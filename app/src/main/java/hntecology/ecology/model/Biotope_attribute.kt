...
class Biotope_attribute(var id:String?, var GROP_ID:String? ,var PRJ_NAME:String?,var INV_REGION:String?, var INV_PERSON:String?, var INV_DT:String?, var INV_TM:String?, var INV_INDEX:Int?,
                        ...
                        var STRE_H:Float?, var STRE_BRT:Float?, var STRE_COVE:Float?, var SHR_SPEC:String?, var SHR_FAMI:String?, var SHR_SCIEN:String?,
                        ...
                        , var  HER_HET_X:Float? , var  HER_HET_N:Float?,var BIO_TYPE:String?, var IMPERV:Float?) :Serializable {
}
