...
class Floras (
        ...
        , var Species_name_kr: String?  , var Subspecies_subsp:String? ,var Subspecies_name: String?  , var Subspecies_name_kr: String?, var Variety_var: String?, var Variety_name: String?,
        var Variety_name_kr: String?, var Forma_f: String?, var Forma_name: String?, var Forma_name_kr: String?,var chkSelect: Boolean
): Serializable {
}
